...
Public Class ProdAves_PerfilClientes_Granjas_Frm
    Inherits Page
    Private ObjUser As UsuarioModel
    Private Plataforma As String = "54"
    Private menu As String = "41"
    ...
    Sub LlenaRPT()
        Try
            rptRegistros.DataSource = New ProdAves_PerfilCliente_Granjas().FindAll(regPId.Text, 0)
    ...
    Sub Guardar()
        ...
        Try
            ...
            Dim ObjM As New ProdAves_PerfilCliente_Granjas()
    ...
    Sub mpe_fill()
        Try
            Select Case mpe_op.Text
                Case "action_edit"
                    Dim ObjM As ProdAves_PerfilCliente_GranjasModel = New ProdAves_PerfilCliente_Granjas().FindById(regPId.Text, CInt(mpe_regId.Text))

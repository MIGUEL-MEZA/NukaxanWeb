<%@ Page Title="" Language="VB" Async="true" MasterPageFile="~/Master_Nukaxan.Master" AutoEventWireup="true" CodeBehind="Nukaxan_UsuariosI_View.aspx.vb" Inherits="NukaxanWEB.Nukaxan_UsuariosI_View" %>
        ...
        <asp:UpdatePanel runat="server" ID="UPContenido" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div style="overflow-y: scroll; height: 59vh; width: 100%; border: solid 0px red;">
                    <%--Grid--%>
                    <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" DataKeyNames="userId" ShowHeader="true"
                        Width="129%" ShowFooter="false" AllowPaging="True" CellPadding="1"
                        CssClass="datagrid">
                        <HeaderStyle />
                        <Columns>
                            <asp:BoundField DataField="userId" HeaderText="" HeaderStyle-Width="7%" />
                            <asp:BoundField DataField="CodUsuario" HeaderText="" HeaderStyle-Width="7%" />
                            <asp:TemplateField HeaderText="" HeaderStyle-Width="20%">
                                <ItemTemplate>
                                    <asp:Label ID="CveRol" runat="server" Text='<%# Eval("CveRol") %>' Visible="false"></asp:Label>
                                    <asp:Label ID="Dependencias" runat="server" Text='<%# Eval("Dependencias") %>' Visible="false"></asp:Label>
                                    <asp:Label ID="FolioR" runat="server" Text='<%# Eval("NomUsuario") %>'></asp:Label>
                                    ...
                                    <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                        <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("userId") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                            ...
                            <asp:BoundField DataField="Email" HeaderText="" HeaderStyle-Width="15%" />
                            <asp:BoundField DataField="NomPuesto" HeaderText="" HeaderStyle-Width="15%" />
                           <%-- <asp:BoundField DataField="NomUbicacion" HeaderText="" HeaderStyle-Width="15%" />--%>
                            <asp:BoundField DataField="NomArea" HeaderText="" HeaderStyle-Width="15%" />
                          <%--  <asp:BoundField DataField="NomLider" HeaderText="" HeaderStyle-Width="15%" />--%>
                            <asp:BoundField DataField="NomRol" HeaderText="" HeaderStyle-Width="10%" />
                    ...
                    <div id="MPEbody_Filtros" runat="server" class="modalPopup_body" align="left">
                        <table width='100%' class="table table_noborder" cellpadding='3' border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLFiltroRol" Width="95%" CssClass="form-control" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLFiltroPuesto" Width="95%" CssClass="form-control" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                           <%-- <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLFiltroUbicacion" Width="95%" CssClass="form-control" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </td>
                            </tr>--%>
                             <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLFiltroArea" Width="95%" CssClass="form-control" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                     ...
                     <div id="MPEBody_Captura" runat="server" class="modalPopup_body" align="left" >
                        <table width="100%" class="table table_noborder" border="0">
                            ...
                            <tr>
                                <td class="table-td">
                                    <asp:Label runat="server" ID="LBLPC13" CssClass="control-label"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="table-td">
                                    <asp:Label runat="server" ID="LBLPC14" CssClass="control-label"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLRolPE" Width="95%" CssClass="form-control" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>

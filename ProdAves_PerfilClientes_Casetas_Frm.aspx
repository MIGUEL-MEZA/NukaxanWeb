<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_ProdAves.Master" CodeBehind="ProdAves_PerfilClientes_Casetas_Frm.aspx.vb" Inherits="NukaxanWEB.ProdAves_PerfilClientes_Casetas_Frm" %>
                                    ...
                                    <div align="left" style="display: block; width: 100%; overflow-y: scroll; height: 300px;">
                                        <asp:Repeater ID="rptRegistros" runat="server">
                                                ...
                                                <table width='100%' cellpadding='3' border="1" class="datagrid">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width='20%'>
                                                                <asp:Label runat="server" ID="Label2">GRANJA</asp:Label>
                                                            </th>
                                                            <th width='8%'>
                                                                <asp:Label runat="server" ID="Label9">CAPACIDAD</asp:Label>
                                                            </th>
                                                             <th width='10%'>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td align="center">
                                                        <asp:Label runat="server" ID="Label7" Text='<%# Eval("CveGranja").ToString + "." + Eval("CveCaseta").ToString%>' CssClass="control-value bold"></asp:Label>
                                                        <asp:Label runat="server" ID="CveGranja" Text='<%# Eval("CveGranja")%>'  Visible="false"></asp:Label>
                                                        <asp:Label runat="server" ID="CveCaseta" Text='<%# Eval("CveCaseta")%>' Visible="false"></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        ...
                                                        <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                                            <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveCaseta").ToString + "|" + Eval("CveGranja").ToString %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                        <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveCaseta").ToString + "|" + Eval("CveGranja").ToString %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                        </asp:Panel>                                                    
                                                    </td>
                                                    <td align="center " class="justify-content-center">
                                                        <asp:Label runat="server" ID="Label8" Text='<%# Eval("CveGranja").ToString + ". " + Eval("NomGranja")%>' CssClass="control-value "></asp:Label>
                                                    </td>
                                                    <td align="center " class="justify-content-center">
                                                        ...
                                                        <asp:Label runat="server" ID="TotalCasetas" Text='<%# Eval("Capacidad")%>' CssClass="control-value"></asp:Label>
                                                    </td>
                                                     <td align="center">
                    ...
                    <div id="MPEBody_Captura" runat="server" class="modalPopup_body" align="left">
                        <table width="100%" class="table table_noborder" border="1" style="border: solid 1px #efefef;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLGranjaE" Width="95%" CssClass="form-control">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TBCapacidadE" runat="server" CssClass="form-control " AutoCompleteType="Disabled"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">

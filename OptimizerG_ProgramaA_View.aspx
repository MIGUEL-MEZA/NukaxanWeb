<%@ Page Title="" Language="VB" Async="true" MasterPageFile="~/Master_OptimizerG.Master" AutoEventWireup="true" CodeBehind="OptimizerG_ProgramaA_View.aspx.vb" Inherits="NukaxanWEB.OptimizerG_ProgramaA_View" %>
                ...
                <div style="overflow-y: scroll; height: 57vh; width: 100%;">
                    <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" DataKeyNames="CvePlan" ShowHeader="true"
                       Width="100%" ShowFooter="false" AllowPaging="True" CssClass="datagrid" CellSpacing="0">                       
                        <HeaderStyle />
                        <Columns>
                             <asp:BoundField DataField="CvePlan" HeaderText="" HeaderStyle-Width="6%" />
                            ...
                            <asp:BoundField DataField="NomModalidad" HeaderText="" HeaderStyle-Width="10%" />
                            <asp:BoundField DataField="NomCliente" HeaderText="" HeaderStyle-Width="22%" />
                            <asp:BoundField DataField="NomReferencia" HeaderText="" HeaderStyle-Width="13%" />                                                      

<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_Nukaxan.Master" CodeBehind="Nukaxan_Clientes_Equipos_Frm.aspx.vb" Inherits="NukaxanWEB.Nukaxan_Clientes_Equipos_Frm" %>
                        ...
                        <table width="100%" runat="server" class="table_noborder" border="0" style="border: 0px;" clientidmode="Static">
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    ...
                                    <div align="left" style="display: block; width: 80%;overflow-y: scroll; height: 300px;">                                        
                                        <asp:Repeater ID="rptEquipos" runat="server">
                                            <HeaderTemplate>
                                                <table width='100%' cellpadding='3' border="1" class="datagrid">
                                                    <thead>
                                                        <tr>
                                                            <th width='40%'>
                                                                <asp:Label runat="server" ID="Label3">EQUIPO</asp:Label>
                                                            </th>
                                                            <th width='20%'>
                                                                <asp:Label runat="server" ID="Label1">SERIE</asp:Label>
                                                            </th>
                                                            <th width='20%'>
                                                                <asp:Label runat="server" ID="Label2">FECHA ASIGNACIÓN</asp:Label>
                                                            </th> 
                                                             <th width='20%'>
                                                                <asp:Label runat="server" ID="Label4">ESTATUS</asp:Label>
                                                            </th>
                                                        </tr>
                                                    </thead>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <tr>
                                                    <td align="center">
                                                        <asp:Label runat="server" ID="NomEquipo" Text='<%# Eval("NomEquipo")%>' CssClass="control-value"></asp:Label>
                                                    </td>
                                                    <td align="left" class="justify-content-center">
                                                        ...
                                                        <asp:Label runat="server" ID="Serie" Text='<%# Eval("Serie")%>' CssClass="control-value bold"></asp:Label>
                                                    ...
                                                    <td align="center">
                                                        <asp:TextBox ID="TBFecAsignacion" runat="server" CssClass="form-control " Text='<%# If(IsDBNull(Eval("FecAsignacion")), "", CDate(Eval("FecAsignacion")).ToString("dd/MM/yyyy"))%>' AutoCompleteType="Disabled" Width="100px"></asp:TextBox>
                                                        <asp:CalendarExtender runat="server" ID="CalendarExtender9" Animated="true" Format="dd/MM/yyyy" TargetControlID="TBFecAsignacion"></asp:CalendarExtender>
                                                    </td>
                                                    <td align="center">
                    ...
                    <div id="MPEBody_Captura" runat="server" class="modalPopup_body" align="left">
                        <table width="100%" class="table table_noborder" border="1" style="border:solid 1px #efefef;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLEquipoPE" Width="95%" CssClass="form-control" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </td>
                            </tr>                            
                        </table>

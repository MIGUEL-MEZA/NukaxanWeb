<%@ Page Title="" Language="VB" Async="true" MasterPageFile="~/Master_Nulink.Master" AutoEventWireup="true" CodeBehind="Nulink_Admin_CatLineasGeneticas_View.aspx.vb" Inherits="NukaxanWEB.Nulink_Admin_CatLineasGeneticas_View" %>
        ...
        <asp:UpdatePanel runat="server" ID="UPContenido" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div style="overflow-y: scroll; height: 59vh; width: 100%; border: solid 0px red;">
                    <%--Grid--%>
                    <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" DataKeyNames="CveLineaG" ShowHeader="true"
                        Width="100%" ShowFooter="false" AllowPaging="True" CellPadding="1"
                        CssClass="datagrid">
                        <HeaderStyle />
                        <Columns>
                            <asp:BoundField DataField="CveLineaG" HeaderText="" HeaderStyle-Width="7%" />
                            <asp:TemplateField HeaderText="" HeaderStyle-Width="18%">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="FolioR" runat="server" Text='<%# Eval("NomLineaG") %>'></asp:Label>
                                    ...
                                    <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                        <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveLineaG") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                            ImageAlign="AbsMiddle" />                                       
                                        <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveLineaG") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                            ImageAlign="AbsMiddle" />
                                    </asp:Panel>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="CodeLineaG" HeaderText="" HeaderStyle-Width="8%" />
                            <asp:BoundField DataField="EdadIni_Crianza" HeaderText="" HeaderStyle-Width="8%" />
                            <asp:BoundField DataField="EdadFin_Crianza" HeaderText="" HeaderStyle-Width="8%" />
                            <asp:BoundField DataField="EdadIni_Postura" HeaderText="" HeaderStyle-Width="8%" />
                            <asp:BoundField DataField="EdadFin_Postura" HeaderText="" HeaderStyle-Width="8%" />
                            <asp:BoundField DataField="NomEstatus" HeaderText="" HeaderStyle-Width="10%" />
                            <asp:BoundField DataField="FecAct" HeaderText="" HeaderStyle-Width="10%" DataFormatString="{0:dd/MM/yyyy HH:mm}" />
                    ...
                    <div id="MPEBody_Captura" runat="server" class="modalPopup_body" align="left" >
                        <table width="100%" class="table table_noborder" border="1" style="border:solid 1px #efefef;">
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <asp:TextBox ID="TBCodigoE" runat="server" CssClass="form-control ucase" Width="170px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="table-td">
                                ...
                                <td valign="top">
                                    <asp:TextBox ID="TBEdadIni_CrianzaE" runat="server" CssClass="form-control " Width="100px" MaxLength="4" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" TargetControlID="TBEdadIni_CrianzaE" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                                    <asp:Label runat="server" ID="Label1" CssClass="control-label semibold"> -- </asp:Label>
                                    <asp:TextBox ID="TBEdadFin_CrianzaE" runat="server" CssClass="form-control " Width="100px" MaxLength="4" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" TargetControlID="TBEdadFin_CrianzaE" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                                </td>
                            </tr>                            
                            <tr>
                                <td valign="top" class="table-td">
                                ...
                                <td valign="top">
                                    <asp:TextBox ID="TBEdadIni_PosturaE" runat="server" CssClass="form-control " Width="100px" MaxLength="4" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" TargetControlID="TBEdadIni_PosturaE" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                                    <asp:Label runat="server" ID="Label3" CssClass="control-label semibold"> -- </asp:Label>
                                    <asp:TextBox ID="TBEdadFin_PosturaE" runat="server" CssClass="form-control " Width="100px" MaxLength="4" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" TargetControlID="TBEdadFin_PosturaE" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                                </td>
                            </tr>                           
                            <tr>
                                <td valign="top" class="table-td">
                                ...
                                <td valign="top">
                                    <asp:DropDownList runat="server" ID="DDLEstatusE" CssClass="form-control semibold" Width="150px">
                                    </asp:DropDownList>
                                </td>
                            </tr>                           
                        </table>

<%@ Page Title="" Language="VB" Async="true" MasterPageFile="~/Master_Nireo.Master" AutoEventWireup="true" CodeBehind="Nireo_CatParametros_View.aspx.vb" Inherits="NukaxanWEB.Nireo_CatParametros_View" %>
        ...
        <asp:UpdatePanel runat="server" ID="UPContenido" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div style="overflow-y: scroll; height: 59vh; width: 100%; border: solid 0px red;">
                    <%--Grid--%>
                    <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" DataKeyNames="CveParametro" ShowHeader="true"
                        Width="100%" ShowFooter="false" AllowPaging="True" CellPadding="1"
                        CssClass="datagrid">
                        <HeaderStyle />
                        <Columns>
                            <asp:BoundField DataField="CveParametro" HeaderText="" HeaderStyle-Width="5%" />
                            <asp:TemplateField HeaderText="" HeaderStyle-Width="23%">
                                <ItemTemplate>
                                    ...
                                    <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                        <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveParametro") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                            ImageAlign="AbsMiddle" />
                                        <asp:Label runat="server">|</asp:Label>
                                        <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveParametro") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                            ImageAlign="AbsMiddle" />
                                    </asp:Panel>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="CodParametro" HeaderText="" HeaderStyle-Width="10%" />
                            <asp:BoundField DataField="CodALLIX" HeaderText="" HeaderStyle-Width="10%" />
                            <asp:BoundField DataField="Familia" HeaderText="" HeaderStyle-Width="15%" />
                            <asp:BoundField DataField="Unidad" HeaderText="" HeaderStyle-Width="8%" />
                            <asp:BoundField DataField="Decimales" HeaderText="" HeaderStyle-Width="8%" />
                            ...
                            <asp:BoundField DataField="NomUsuAct" HeaderText="" HeaderStyle-Width="16%" />
                        </Columns>
                    ...
                    <div id="MPEbody_Filtros" runat="server" class="modalPopup_body" align="left">
                        <table width='100%' class="table table_noborder" cellpadding='3' border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TBFiltroFamilia" runat="server" CssClass="form-control ucase" Width="100%"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="100%" class="table table_noborder" border="0">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td valign="top">
                                    <asp:TextBox ID="TBCodigoALLIXE" runat="server" CssClass="form-control ucase" Width="100%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="table-td">
                                ...
                                <td valign="top">
                                    <asp:TextBox ID="TBNombreFamiliaE" runat="server" CssClass="form-control ucase" Width="100%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="table-td">
                                ...
                                <td valign="top">
                                    <asp:TextBox ID="TBUnidadE" runat="server" CssClass="form-control ucase" Width="100%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="table-td">
                                ...
                                <td valign="top">
                                    <asp:TextBox ID="TBDecimalesE" runat="server" CssClass="form-control ucase" Width="70px" MaxLength="1"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FTE1" runat="server" FilterType="Numbers" TargetControlID="TBDecimalesE" />
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="table-td">

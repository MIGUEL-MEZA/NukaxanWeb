<%@ Page Title="" Language="VB" Async="true" MasterPageFile="~/Master_Nukaxan.Master" AutoEventWireup="true" CodeBehind="Nukaxan_UsuariosE_View.aspx.vb" Inherits="NukaxanWEB.Nukaxan_UsuariosE_View" %>
            ...
            <ContentTemplate>
                ...
                <div class="bar-actions" style="display: inline-block;">
                    <div align="left">
                        ...
                        <asp:LinkButton ID="LB412" runat="server" OnClick="Agregar" CssClass="lnk-action">
                ...
                <div style="overflow-y: scroll; height: 59vh; width: 100%; border: solid 0px red;">
                    <%--Grid--%>
                    <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" DataKeyNames="CodUsuario" ShowHeader="true"
                        Width="135%" ShowFooter="false" AllowPaging="True" CellPadding="1"
                        CssClass="datagrid">
                        <HeaderStyle />
                        <Columns>                           
                            <asp:BoundField DataField="NomCliente" HeaderText="" HeaderStyle-Width="18%" />
                            ...
                            <asp:TemplateField HeaderText="" HeaderStyle-Width="20%">
                                <ItemTemplate>
                                    ...
                                    <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                        <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CodUsuario") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                            ...
                            <asp:BoundField DataField="NomPuesto" HeaderText="" HeaderStyle-Width="18%" />
                           <%-- <asp:BoundField DataField="NomUbicacion" HeaderText="" HeaderStyle-Width="15%" />--%>
                            <asp:BoundField DataField="NomArea" HeaderText="" HeaderStyle-Width="12%" />                          
                            <asp:BoundField DataField="NomRol" HeaderText="" HeaderStyle-Width="12%" />
                    ...
                    <div id="MPEbody_Filtros" runat="server" class="modalPopup_body" align="left">
                        <table width='100%' class="table table_noborder" cellpadding='3' border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLFiltroCliente" Width="95%" CssClass="form-control">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>

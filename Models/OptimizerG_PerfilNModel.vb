...
Public Class OptimizerG_PerfilNModel
    ...
    Public Property ITH As Double = 0
    Public Property CveITH As Integer = 0
    Public Property ImgITH As String = ""
    Public Property DesperdicioP As Double = 0
    Public Property DesperdicioC As Double = 0
    Public Property CveEstatusC As Double = 0
    Public Property CveTipoInstalacion As Double = 0
    ...
    Public Property NomITH As String = ""
    Public Property NomEstatusC As String = ""
    Public Property NomTipoInstalacion As String = ""

...
Public Class OptimizerP_PerfilNModel
    ...
    Public Property PreIniNupio As String = ""
    ...
    Public Property Desperdicio As Double = 0
    ...
    Public Property NomPreIniNupio As String = ""
    Public Property NomITH As String = ""
    Public Property Productividad As Double = 0

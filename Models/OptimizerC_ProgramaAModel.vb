...
Public Class OptimizerC_ProgramaAModel
    ...
    Public Property PesoPromedioDestete As Double = 0
    Public Property EdadDestete As Integer = 0
    Public Property EdadSalida As Integer = 0
    Public Property EdadVenta As Integer = 0
    Public Property PrecioVenta As Double = 0
    'Public Property DiasRactopamina As Integer = 0
    Public Property Temperatura As Double = 0
    Public Property CveEstado As Integer = 0
    Public Property EspacioCorral As Double = 0
    Public Property DesperdicioComedero As Double = 0

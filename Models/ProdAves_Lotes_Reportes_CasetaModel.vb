Public Class ProdAves_Lotes_Reportes_CasetaModel
    ...
    Public Property AvesMuertasAc As Integer = 0
    ...
    Public Property ConsumoAguaAD As Double = 0
    Public Property ConsumoAguaAc As Double = 0
    Public Property PesoAve As Double = 0
    Public Property GSP As Double = 0
    Public Property CA As Double = 0
    ...
    Public Property MasaHuevoAcAD As Double = 0
    Public Property MasaHuevoAA As Double = 0
    Public Property MasaHuevoAcAA As Double = 0

    'Estandares
    Public Property Est_MortalidadAc As Double = 0
    Public Property Est_PesoCorporal As Double = 0
    Public Property Est_ConsumoAlimAD As Double = 0
    Public Property Est_ConsumoAguaAD As Double = 0
    Public Property Est_ProduccionAD As Double = 0
    Public Property Est_HuevoAcAD As Double = 0
    Public Property Est_HuevoAcAA As Double = 0
    Public Property Est_MasaHuevoAcAA As Double = 0
    Public Property Est_PesoHuevo As Double = 0

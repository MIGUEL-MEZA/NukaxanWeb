Public Class Nulink_Captura_PosturaModel
    ...
    Public Property UniformidadH As Double = 0
    Public Property TotalHuevos As Double = 0
    ...
    Public Property Cal_Postura As Double = 0
    Public Property Cal_ProduccionAD As Double = 0
    Public Property Cal_ProduccionAA As Double = 0
    Public Property Cal_MasaHuevoAD As Double = 0
    Public Property Cal_MasaHuevoAcumulada As Double = 0
    Public Property Cal_ConversionA As Double = 0
    Public Property Cal_CostoProducirHuevo As Double = 0
    Public Property Cal_Utilidad As Double = 0

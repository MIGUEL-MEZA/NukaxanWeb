...
Public Class OptimizerG_ProgramaAModel
    ...
    Public Property TotalGallinas As Integer = 0
    Public Property TotalPollitas As Integer = 0
    Public Property PrecioVentaH As Double = 0

<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_ProdAves.Master" CodeBehind="ProdAves_Crianza_Lotes_ProgramaAlim_Frm.aspx.vb" Inherits="NukaxanWEB.ProdAves_Crianza_Lotes_ProgramaAlim_Frm" %>
                                ...
                                <div align="left" style="display: block; width: 100%; overflow-y: scroll; height: 300px;">
                                    <asp:Repeater ID="rptRegistros" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                 <td align="center">
                                                    <asp:Label runat="server" ID="CveFase" Text='<%#Eval("CveFase")%>' CssClass="control-value color-red "></asp:Label>
                                                </td>
                                                <td align="left">
                                                    ...
                                                    <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                                        <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveFase").ToString + "-" + Eval("EdadIni").ToString %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                         <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveFase").ToString + "-" + Eval("EdadIni").ToString %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                    </asp:Panel>
                                                </td>
                                                <td align="center">

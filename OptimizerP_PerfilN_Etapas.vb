...
Public Class OptimizerP_PerfilN_Etapas
    ...
    Public Function getSQL(CodCliente As String, CvePerfilN As Int64) As String
        ...
        sb.Append(" EXEC spc_OptimizerP_PerfilNutricional_Etapas @CodCliente,@CvePerfilN,@Estatus Output,@Mensaje Output")
    ...
    Public Function FindAll(CodCliente As String, CvePerfilN As Int64) As DataTable
        ...
        Return dt
    End Function
    Public Function FindlstAll(CodCliente As String, CvePerfilN As Int64) As List(Of OptimizerP_PerfilN_EtapasModel)
        Dim dt As DataTable
        Dim lst As New List(Of OptimizerP_PerfilN_EtapasModel)
        Try
            dt = FindAll(CodCliente, CvePerfilN)
            For Each dr As DataRow In dt.Rows
                Dim ObjM As OptimizerP_PerfilN_EtapasModel = FillModel(dr)
                lst.Add(ObjM)
            Next
        ...
        Return lst
    End Function
    Public Function FindById(CodCliente As String, CvePerfilN As Int64) As OptimizerP_PerfilN_EtapasModel
        Dim dt As DataTable
        Dim ObjM As OptimizerP_PerfilN_EtapasModel
        Try
            dt = FindAll(CodCliente, CvePerfilN)
        ...
        Return ObjM
    End Function
    Public Function FillModel(dr As DataRow) As OptimizerP_PerfilN_EtapasModel
        Dim ObjModel As New OptimizerP_PerfilN_EtapasModel

<%@ Page Title="" Language="VB" Async="true" MasterPageFile="~/Master_ProdAves.Master" AutoEventWireup="true" CodeBehind="ProdAves_AdminClientes_View.aspx.vb" Inherits="NukaxanWEB.ProdAves_AdminClientes_View" %>
        ...
        if (prm != null) {
            prm.add_endRequest(function (sender, e) {
                if (sender._postBackSettings.panelsToUpdate != null) {                   
                    $("[id*=DDLClienteE]").select2({ dropdownAutoWidth: true, dropdownParent: $('#MainContent_pnlCaptura') });
                }
            });
        };
    </script>
            ...
            <ContentTemplate>
                ...
                <div class="bar-actions" style="display: inline-block;">
                    <div align="left">
                        ...
                        <asp:LinkButton ID="LB45" runat="server" OnClick="Nuevo" CssClass="lnk-action">
                ...
                <asp:Panel ID="pnlCaptura" runat="server" CssClass="modalPopup" Style="display: none;">
                    ...
                    <div id="MPEbody_Seleccionar" runat="server" class="modalPopup_body" align="left">
                        <table width="100%" cellpadding="2" border="0" style="margin-left: 3px;">
                            <tr style="visibility: collapse;">
                                <td width="20%"></td>
                                <td width="80%"></td>
                            ...
                            <tr>
                                <td class="table-td">
                                    <asp:Label runat="server" ID="LBLC1" CssClass="control-label semibold"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLClienteE" Width="95%" CssClass="form-control" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>

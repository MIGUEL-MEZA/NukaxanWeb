<%@ Page Title="" Language="VB" Async="true" MasterPageFile="~/Master_Nireo.Master" AutoEventWireup="true" CodeBehind="Nireo_Muestras_View.aspx.vb" Inherits="NukaxanWEB.Nireo_Muestras_View" %>
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                ...
                                <div class="row2 align-items-center d-flex margin-top-20">
                                    ...
                                    <div class="col-md-1">
                                        <asp:Label runat="server" ID="LBLF11" CssClass="semibold"></asp:Label>
                                    </div>
                                    <div class="col-md-3">

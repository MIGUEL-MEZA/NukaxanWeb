...
Public Class OptimizerP_CatVariables
    ...
    Public Function GetSQL(CveVariable As Integer) As String
        ...
        sb.Append(" EXEC spc_OptimizerP_CatVariables @CveVariable,@Estatus Output,@Mensaje Output")
    ...
    Public Function FindAll(CveVariable As Integer) As DataTable
        ...
        Return dt
    End Function
    Public Function FindlstAll(CveVariable As Integer) As List(Of OptimizerP_CatVariablesModel)
        Dim dt As DataTable
        Dim lst As New List(Of OptimizerP_CatVariablesModel)
        Try
            dt = FindAll(CveVariable)
            For Each dr As DataRow In dt.Rows
                Dim ObjM As OptimizerP_CatVariablesModel = FillModel(dr)
                lst.Add(ObjM)
            Next
        ...
        Return lst
    End Function
    Public Function FindById(CveVariable As Integer) As OptimizerP_CatVariablesModel
        Dim ObjM As New OptimizerP_CatVariablesModel
        Dim dt As DataTable
        Try
            dt = FindAll(CveVariable)

...
Public Class ProdAves_PerfilClientes_Casetas_Frm
    Inherits Page
    Private ObjUser As UsuarioModel
    Private Plataforma As String = "54"
    Private menu As String = "42"
    ...
    End Sub
    Sub LlenaDDL()
        Call New Catalogos().LlenaProdAves_Granjas(DDLGranjaE, regPId.Text)
    ...
    Sub LlenaRPT()
        Try
            rptRegistros.DataSource = New ProdAves_PerfilCliente_Casetas().FindAll(regPId.Text, 0, 0)
    ...
    Sub Guardar()
        ...
        Try
            ...
            Dim ObjM As New ProdAves_PerfilCliente_Casetas()
            IsResult = ObjM.SaveModel(If(CInt(mpe_regId.Text) = 0, 0, 1), Valores, ObjUser.CodUsuario)
            If IsResult Then
                LlenaRPT()
    ...
    Sub Eliminar(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            Dim ObjM As New ProdAves_PerfilCliente_Casetas()
            Dim Valores As String = regPId.Text + "|" + key.Split("|")(0) + "||" + key.Split("|")(1)
    ...
    Sub mpe_open()
        ...
        Select Case mpe_op.Text
            Case "action_add"
                ...
                lblMPE_title.Text = "Nueva Caseta"
                pnlCaptura.Width = 650
                pnlCaptura.Height = 340
                BTNP16.Visible = True
            ...
            Case "action_edit"
                MPEBody_Captura.Visible = True
                lblMPE_title.Text = "Editar Caseta"
                pnlCaptura.Width = 650
                pnlCaptura.Height = 340
                BTNP16.Visible = True
                BTNP16.Text = lstAcciones.Find(Function(p) p.CveTipo = 1 And p.CveAccion = 6).NomAccion
    ...
    Sub mpe_fill()
        Try
            Select Case mpe_op.Text
                Case "action_edit"
                    Dim ObjM As ProdAves_PerfilCliente_CasetasModel = New ProdAves_PerfilCliente_Casetas().FindById(regPId.Text, CInt(mpe_regId2.Text), CInt(mpe_regId.Text))

<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_ProdAves.Master" CodeBehind="ProdAves_Postura_Lotes_Registro_Frm.aspx.vb" Inherits="NukaxanWEB.ProdAves_Postura_Lotes_Registro_Frm" %>
                        ...
                        <div id="Tabs" role="tabpanel">
                            ...
                            <ul class="nav nav-pills" id="myTab" role="tablist">
                                <li class="nav-item active" runat="server" id="li_tab1">
                                    <a class="nav-link" id="tab1" href="#sec1" aria-controls="sec1" role="tab" data-toggle="tab">DATOS</a>
                                </li>
                                <li class="nav-item" runat="server" id="li_tab2">
                                    <a class="nav-link" id="tab2" href="#sec2" aria-controls="sec2" role="tab" data-toggle="tab">BITACORA</a>
                                </li>

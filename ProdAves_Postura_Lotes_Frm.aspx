<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_ProdAves.Master" CodeBehind="ProdAves_Postura_Lotes_Frm.aspx.vb" Inherits="NukaxanWEB.ProdAves_Postura_Lotes_Frm" %>
                            ...
                            <td valign="top">                               
                                ...
                                <table class="table-condensed" border="1" style="border: solid 1px gray; width: 100%;">
                                    <tr>
                                        ...
                                        <td width="70%" class="bg-white">
                                            ...
                                            <asp:Label runat="server" ID="TBCveLoteO" Visible="false"></asp:Label>
                                        </td>
                                    </tr>
                                     <tr>
                                        ...
                                        <td class="bg-white">
                                            <asp:DropDownList ID="DDLEtapa" runat="server" Width="95%" CssClass="form-control">
                                            </asp:DropDownList>
                                            <asp:Label runat="server" ID="TBNomEtapaD" CssClass="control-label "></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg-gray semibold">
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-white">
                                            <asp:TextBox ID="TBCodigo" runat="server" CssClass="form-control text-uppercase semibold color-red" AutoCompleteType="Disabled"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-white">
                                            <asp:DropDownList ID="DDLCveLoteO" runat="server" CssClass="form-control">
                                            </asp:DropDownList>
                                            <asp:Label runat="server" ID="TBCveLoteOD" CssClass="control-label semibold"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg-gray semibold">
                                        ...
                                        <td class="bg-white">
                                            <asp:DropDownList runat="server" ID="DDLGranja" CssClass="form-control">
                                            </asp:DropDownList>
                                            <asp:Label runat="server" ID="TBNomGranjaD" CssClass="control-label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg-gray semibold">
                                        ...
                                        <td class="bg-white">
                                            <asp:DropDownList runat="server" ID="DDLLineaG" AutoPostBack="true" CssClass="form-control">
                                            </asp:DropDownList>
                                            <asp:Label runat="server" ID="TBNomLineaGD" CssClass="control-label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg-gray semibold">
                                        ...
                                        <td class="bg-white">
                                            <asp:DropDownList runat="server" ID="DDLGuia" CssClass="form-control">
                                            </asp:DropDownList>
                                            <asp:Label runat="server" ID="TBNomGuiaD" CssClass="control-label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg-gray semibold">
                                        ...
                                        <td class="bg-white">
                                            <asp:TextBox ID="TBFecNacimiento" runat="server" CssClass="form-control text-uppercase" Width="150px" AutoCompleteType="Disabled"></asp:TextBox>
                                            <asp:CalendarExtender runat="server" ID="CalendarExtender9" Animated="true" Format="dd/MM/yyyy" TargetControlID="TBFecNacimiento"></asp:CalendarExtender>
                                            <asp:Label runat="server" ID="TBFecNacimientoD" CssClass="control-label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg-gray semibold">
                                        ...
                                        <td class="bg-white">
                                            <asp:DropDownList runat="server" ID="DDLEstatus" Width="200px" CssClass="form-control semibold">
                                            </asp:DropDownList>
                                ...
                                <table class="table-condensed" border="1" style="border: solid 1px gray; width: 100%;">
                                    <tr>
                                        ...
                                        <td width="70%" class="bg-white">
                                            <asp:Label runat="server" ID="TBEdadD" CssClass="control-label "></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg-gray semibold">
                                        ...
                                        <td class="bg-white">
                                            <asp:Label runat="server" ID="TBFecRecepcionD" CssClass="control-label "></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg-gray semibold">
                                        ...
                                        <td class="bg-white">
                                            <asp:Label runat="server" ID="TBFecCierreD" CssClass="control-label "></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg-gray semibold">
                                        ...
                                        <td class="bg-white">
                                            <asp:Label runat="server" ID="TBAvesInicialesD" CssClass="control-label "></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg-gray semibold">
                                        ...
                                        <td class="bg-white">
                                            <asp:Label runat="server" ID="TBAvesFinalesD" CssClass="control-label "></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <br />

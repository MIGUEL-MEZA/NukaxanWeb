...
Public Class OptimizerC_ProgramaA
    ...
    Public Function getSQL(CvePlan As Int64, CvePerfilN As Int64, CodUsuario As String) As String
        ...
        sb.Append(" EXEC spc_OptimizerC_ProgramaA @CvePlan,@CvePerfilN,@CodUsuario,@Estatus Output,@Mensaje Output")
    ...
    Public Function FindAll(CvePlan As Int64, CvePerfilN As Int64, CodUsuario As String) As DataTable
        ...
        Return dt
    End Function
    Public Function FindlstAll(CvePlan As Int64, CvePerfilN As Int64, CodUsuario As String) As List(Of OptimizerC_ProgramaAModel)
        Dim dt As DataTable
        Dim lst As New List(Of OptimizerC_ProgramaAModel)
        Try
            dt = FindAll(CvePlan, CvePerfilN, CodUsuario)
            For Each dr As DataRow In dt.Rows
                Dim ObjM As OptimizerC_ProgramaAModel = FillModel(dr)
                lst.Add(ObjM)
            Next
        ...
        Return lst
    End Function
    Public Function FindById(CvePlan As Int64, CvePerfilN As Int64, CodUsuario As String) As OptimizerC_ProgramaAModel
        Dim dt As DataTable
        Dim ObjM As OptimizerC_ProgramaAModel
        Try
            dt = FindAll(CvePlan, CvePerfilN, CodUsuario)
        ...
        Return ObjM
    End Function
    Public Function FillModel(dr As DataRow) As OptimizerC_ProgramaAModel
        Dim ObjModel As New OptimizerC_ProgramaAModel
        ...
        ObjModel.PesoPromedioDestete = dr("PesoPromedioDestete")
        ObjModel.EdadDestete = dr("EdadDestete")
        ObjModel.EdadSalida = dr("EdadSalida")
        ObjModel.EdadVenta = dr("EdadVenta")
        ObjModel.PrecioVenta = dr("PrecioVenta")
        ' ObjModel.DiasRactopamina = dr("DiasRactopamina")
        ObjModel.Temperatura = dr("Temperatura")
        ObjModel.CveEstado = dr("CveEstado")
        'ObjModel.CerdosxCorral = dr("CerdosxCorral")
        ObjModel.EspacioCorral = dr("EspacioCorral")
        ObjModel.DesperdicioComedero = dr("DesperdicioComedero")
        ...
        ObjModel.NomEstado = dr("NomEstado")
    ...
    Public Function SaveModel(CvePlan As Int64, CvePerfilN As Int64, Valores As String, ValoresE As String, UsuAct As String) As Boolean
        ...
        Try
            ...
            sb.Append(" EXEC spiud_OptimizerC_ProgramaA @Opcion,@CvePlan,@CvePerfilN,@Valores,@ValoresE,@UsuAct,@Estatus Output,@Mensaje Output,@Id Output")

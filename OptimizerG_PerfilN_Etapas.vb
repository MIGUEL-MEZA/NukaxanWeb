...
Public Class OptimizerG_PerfilN_Etapas
    ...
    Public Function getSQL(CodCliente As String, CvePerfilN As Int64) As String
        ...
        sb.Append(" EXEC spc_OptimizerG_PerfilNutricional_Etapas @CodCliente,@CvePerfilN,@Estatus Output,@Mensaje Output")
    ...
    Public Function FindAll(CodCliente As String, CvePerfilN As Int64) As DataTable
        ...
        Return dt
    End Function
    Public Function FindlstAll(CodCliente As String, CvePerfilN As Int64) As List(Of OptimizerG_PerfilN_EtapasModel)
        Dim dt As DataTable
        Dim lst As New List(Of OptimizerG_PerfilN_EtapasModel)
        Try
            dt = FindAll(CodCliente, CvePerfilN)
            For Each dr As DataRow In dt.Rows
                Dim ObjM As OptimizerG_PerfilN_EtapasModel = FillModel(dr)
                lst.Add(ObjM)
            Next
        ...
        Return lst
    End Function
    Public Function FindById(CodCliente As String, CvePerfilN As Int64) As OptimizerG_PerfilN_EtapasModel
        Dim dt As DataTable
        Dim ObjM As OptimizerG_PerfilN_EtapasModel
        Try
            dt = FindAll(CodCliente, CvePerfilN)
        ...
        Return ObjM
    End Function
    Public Function FillModel(dr As DataRow) As OptimizerG_PerfilN_EtapasModel
        ...
        ObjModel.AplicaPesoHuevo = dr("AplicaPesoHuevo")

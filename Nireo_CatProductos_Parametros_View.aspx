<%@ Page Title="" Language="VB" Async="true" MasterPageFile="~/Master_Nireo.Master" AutoEventWireup="true" CodeBehind="Nireo_CatProductos_Parametros_View.aspx.vb" Inherits="NukaxanWEB.Nireo_CatProductos_Parametros_View" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>         
        ...
        $(document).ready(function () {            
            ...
            $('[id*=DDLCategoriaPE]').select2({ dropdownParent: $('#MainContent_pnlPopup') });
        ...
        if (prm != null) {
            prm.add_endRequest(function (sender, e) {
                if (sender._postBackSettings.panelsToUpdate != null) {                    
                    ...
                    $("[id*=DDLCategoriaPE]").select2({ dropdownAutoWidth: true, dropdownParent: $('#MainContent_pnlPopup') });
                }
            });
        };
    </script>
            ...
            <ContentTemplate>
                ...
                <div class="bar-actions" style="display: inline-block;">
                    <div align="left">
                        ...
                        <asp:LinkButton ID="LB410" runat="server" OnClick="Editar" CssClass="lnk-action">
                            <asp:Image ID="IMG410" runat="server" ImageAlign="AbsMiddle" ImageUrl="Content/Image/action_form_edit_PDF.png" />
                            <asp:Label runat="server" ID="LBL410"></asp:Label>
                        </asp:LinkButton>
                ...
                <div style="overflow-y: scroll; height: 59vh; width: 100%; border: solid 0px red;">
                    ...
                    <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" DataKeyNames="CveCategoriaP,CveParametro" ShowHeader="true"
                        ...
                        <HeaderStyle />
                        <Columns>
                            <asp:BoundField DataField="CveCategoriaP" HeaderText="" HeaderStyle-Width="6%" />
                            <asp:BoundField DataField="NomCategoriaP" HeaderText="" HeaderStyle-Width="15%" />
                            <asp:BoundField DataField="CveParametro" HeaderText="" HeaderStyle-Width="6%" />
                            <asp:BoundField DataField="NomParametro" HeaderText="" HeaderStyle-Width="18%" />
                             <asp:TemplateField HeaderText="" HeaderStyle-Width="10%">
                                <ItemTemplate>                                    
                                    ...
                                    <asp:Label runat="server" ID="Critico" Text='<%# Eval("Critico") %>' Visible="false"></asp:Label>
                                   <asp:DropDownList runat="server" ID="DDLCritico" Width="80px" CssClass="form-control" >
                                    </asp:DropDownList>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="" HeaderStyle-Width="10%">
                                <ItemTemplate>
                                   <asp:TextBox ID="TBMinValor" runat="server" Text='<%# Eval("MinValor") %>' CssClass="form-control " Width="80px" ></asp:TextBox>
                                   <asp:FilteredTextBoxExtender ID="FTE1" runat="server" FilterType="Custom,Numbers" TargetControlID="TBMinValor" ValidChars="." />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="" HeaderStyle-Width="10%">
                                <ItemTemplate>
                                   <asp:TextBox ID="TBMaxValor" runat="server" Text='<%# Eval("MaxValor") %>' CssClass="form-control " Width="80px"></asp:TextBox>
                                   <asp:FilteredTextBoxExtender ID="FTE2" runat="server" FilterType="Custom,Numbers" TargetControlID="TBMaxValor" ValidChars="." />
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup" Style="display: none;">
                    ...
                    <div id="MPEBody_Captura" runat="server" class="modalPopup_body" align="left" style="overflow-y: scroll; height: 450px;">
                        <table width="100%" class="table table_noborder" border="0">
                           ...
                           <tr>
                                <td class="table-td">
                                    <asp:Label runat="server" ID="LBLC1" class="control-label"></asp:Label>
                                </td>
                                <td>
                                   <asp:DropDownList runat="server" ID="DDLCategoriaPE" AutoPostBack="true" Width="95%" CssClass="form-control" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td valign="top">
                                    <asp:CheckBoxList ID="ChkParametrosE" runat="server" CssClass="control-chklist" >
                                </asp:CheckBoxList>
                                </td>
                            </tr>

<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_Nukaxan.Master" CodeBehind="Nukaxan_Clientes_ProductosParametros_Frm.aspx.vb" Inherits="NukaxanWEB.Nukaxan_Clientes_ProductosParametros_Frm" %>
                                                ...
                                                <table width='100%' cellpadding='3' border="1" class="datagrid">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width='20%'>
                                                                <asp:Label runat="server" ID="Label22">PARÁMETRO</asp:Label>
                                                            </th>
                                                             <th width='20%'>
                                                            ...
                                                            <th width='10%'>
                                                                <asp:Label runat="server" ID="Label6">VALOR MÍNIMO</asp:Label>
                                                            </th>
                                                            <th width='10%'>
                                                                <asp:Label runat="server" ID="Label7">VALOR MÁXIMO</asp:Label>
                                                            </th>--%>
                                                            <th width='20%'>

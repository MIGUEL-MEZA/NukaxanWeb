...
Public Class OptimizerP_PerfilN_Frm
    Inherits Page
    ...
    Sub Controles(op As Boolean)
        Try
            Dim excepciones As String = "42-2-1,42-2-2,42-2-19,42-2-20,42-2-21"
    ...
    Sub LlenaDDL()
        ...
        Call New Catalogos().LlenaOpcionGeneral(DDLPreIniNupio, "1")
    End Sub
    ...
    Sub LlenaRPT_Etapas()
        Try
            rptEtapas.DataSource = New OptimizerP_PerfilN_Etapas().FindAll(CodCliente.Text, CInt(regPId.Text))
            rptEtapas.DataBind()
        Catch ex As Exception
    ...
    Protected Sub RPTOnItemDataBound(ByVal sender As Object, ByVal e As RepeaterItemEventArgs) Handles rptEtapas.ItemDataBound
        If e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Call New Catalogos().LlenaOptimizerP_Etapas(DDLEtapaFlujo)
            ...
            TBEdadIni.Enabled = False 'chk.Checked
    ...
    Function GuardaDatos() As Boolean
        ...
        Try
            ...
            Dim ObjM As New OptimizerP_PerfilN()
    ...
    Async Sub Generar()
        Dim IsResult As Boolean
        Dim lst As New List(Of WSOptimizerP_PerfilN_RequestEtapasModel)
        Try
            ...
            rptEtapas.Items.Cast(Of RepeaterItem)().ToList.ForEach(Sub(r)
                                                                       ...
                                                                       If chk.Checked Then lst.Add(New WSOptimizerP_PerfilN_RequestEtapasModel With {.Clave = CveEtapa, .PesoInicial = TBEdadIni, .PesoFinal = TBEdadFin, .EMAlimento = TBEMAlimento})
                                                                   End Sub)

            Dim req As New WSOptimizerP_PerfilN_RequestModel
            req.CvePerfilN = CInt(regPId.Text)
            req.UsuAct = ObjUser.CodUsuario
            req.Referencia = DDLReferencia.SelectedValue
            req.PreIniciadorNupio = If(DDLPreIniNupio.SelectedValue = "S", "SI", DDLPreIniNupio.SelectedValue)

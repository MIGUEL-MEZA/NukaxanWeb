...
Public Class Nireo_CatEquipos_View
    Inherits Page
    ...
    Sub LlenaDDL()
        ...
        Call New Catalogos().LlenaMoneda(DDLMonedaE)
    End Sub
    Sub SeguridadLoad()
    ...
    Sub Exportar()
        ...
        Try
            ...
            dtgv.AsEnumerable.ToList.ForEach(Sub(r)
                                                 ...
                                                 lst.Add(r("Marca"))
                                                 lst.Add(r("Modelo"))
                                                 lst.Add(r("NomProveedor"))
                                                 lst.Add(CDate(r("FechaCompra")).ToString("dd/MM/yyyy"))
                                                 lst.Add(r("Costo"))
                                                 lst.Add(r("NomMoneda"))
    ...
    Sub Guardar()
        ...
        Try
            ...
            Dim Valores As String = TBNombreE.Text.ToUpper + "|" + TBMarcaE.Text.ToUpper + "|" + TBSerieE.Text.ToUpper + "|" + TBModeloE.Text.ToUpper + "||1|" + TBProveedorE.Text.ToUpper + "|" +
               DateTime.ParseExact(TBFecCompraE.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd") + "|" + TBCostoE.Text + "|" + DDLMonedaE.SelectedValue.ToString + "|" + DDLEstatusE.SelectedValue.ToString
            Dim ObjM As New CatEquipos()
            IsResult = ObjM.SaveModel(CInt(mpe_regId.Text), Valores, ObjUser.userId)
            If IsResult Then
                ObtenDatos()
                Alertas("", "6", False, 2)
            Else
    ...
    Sub mpe_clean()
        ...
        Select Case mpe_op.Text
            ...
            Case "action_add", "action_edit"
                ControlesAcciones(0)
                TBNombreE.Text = "NIRONE SENSOR"
                TBMarcaE.Text = "NIRONE"
                TBModeloE.Text = "S 2.0"
                TBProveedorE.Text = "SPECTRAL ENGINES"

                TBNombreE.Enabled = False
                TBProveedorE.Enabled = False
                TBMarcaE.Enabled = False
        End Select
    ...
    Sub mpe_fill()
        Try
            Select Case mpe_op.Text
                Case "action_edit"
                    Dim ObjM As CatEquiposModel = New CatEquipos().FindById(CInt(mpe_regId.Text), 0)
                    Dim excepciones As String = ""

<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_Nukaxan.Master" CodeBehind="Nukaxan_Clientes_Proveedores_Frm.aspx.vb" Inherits="NukaxanWEB.Nukaxan_Clientes_Proveedores_Frm" %>
                                    ...
                                    <div align="left" style="display: block; width: 100%; overflow-y: scroll; height: 300px;">
                                        <asp:Repeater ID="rptProductos" runat="server">
                                                ...
                                                <table width='100%' cellpadding='3' border="1" class="datagrid">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width='15%'>
                                                                <asp:Label runat="server" ID="Label4">ACTUALIZACIÓN</asp:Label>
                                                            </th>                                                           
                                                        </tr>
                                                    </thead>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <tr>
                                                    <td align="center">
                                                        <asp:Label runat="server" ID="CveProveedor" Text='<%# Eval("CveProveedor")%>' CssClass="control-value "></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Label runat="server" ID="NomProveedor" Text='<%# Eval("NomProveedor")%>' CssClass="control-value bold"></asp:Label>
                                                        <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveProveedor") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                        <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveProveedor") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                    </td>

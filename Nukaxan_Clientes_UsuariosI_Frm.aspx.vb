...
Public Class Nukaxan_Clientes_UsuariosI_Frm
    Inherits Page
    ...
    Sub Etiquetas()
        ...
        Menu_Titulo.Text = New Menu_Formulario().FindById(Plataforma, menu, 3).NomMenu
    ...
    Sub LlenaRPT()
        Try
            rptUsuarios.DataSource = New Clientes_UsuariosI().FindAll(regPId.Text)
    ...
    End Sub
    Sub Refrescar()
        Response.Redirect(New RedirectPaginas().FindById(Plataforma + "-" + menu + "-1-3").PaginaURL.Replace("@Id", Codif(regPId.Text)).Replace("@filtro", Codif(filtroview.Text)).Replace("@pageIndex", gvindexpage.Text), True)
    End Sub

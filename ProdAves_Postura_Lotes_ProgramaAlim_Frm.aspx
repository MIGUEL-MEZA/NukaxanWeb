<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_ProdAves.Master" CodeBehind="ProdAves_Postura_Lotes_ProgramaAlim_Frm.aspx.vb" Inherits="NukaxanWEB.ProdAves_Postura_Lotes_ProgramaAlim_Frm" %>
    ...
    <div class="container-fluid w-100 h-100">
        <asp:UpdatePanel runat="server" ID="UPContenido" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <asp:Label runat="server" ID="CveEtapa" Visible="false"></asp:Label>
                                ...
                                <div align="left" style="display: block; width: 100%; overflow-y: scroll; height: 300px;">
                                    <asp:Repeater ID="rptRegistros" runat="server">
                                        <HeaderTemplate>
                                            <table width='100%' cellpadding='3' border="1" class="datagrid">
                                                <thead>
                                                    <tr>
                                                        <th width='6%'>
                                                            <asp:Label runat="server" ID="Label9">ID</asp:Label>
                                                        </th>
                                                        <th width='19%'>
                                                        ...
                                                        <th width='16%'>
                                                            <asp:Label runat="server" ID="Label2">ALIMENTO</asp:Label>
                                                        </th>
                                                        <th width='8%'>
                                                            <asp:Label runat="server" ID="Label3">COSTO</asp:Label>
                                                        </th>
                                                        <th width='9%'>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                 <td align="center">
                                                    <asp:Label runat="server" ID="CveProgramaA" Text='<%#Eval("CveProgramaA")%>' CssClass="control-value color-red "></asp:Label>
                                                </td>
                                                <td align="left">                                                    
                                                    <asp:Label runat="server" ID="CveFase" Text='<%# Eval("CveFase")%>' Visible="false"></asp:Label>
                                                    ...
                                                    <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                                        <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveProgramaA").ToString%>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                         <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveProgramaA").ToString%>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                    </asp:Panel>
                                                </td>
                                                <td align="center">
                                                ...
                                                <td align="center">
                                                    <asp:Label runat="server" ID="NomAlimento" Text='<%# Eval("NomAlimento")%>' CssClass="control-value "></asp:Label>
                                                </td>
                                                <td align="center">
                                                    <asp:Label runat="server" ID="Costo" Text='<%# CDbl(Eval("Costo")).ToString("N2")%>' CssClass="control-value "></asp:Label>
                                                </td>
                                                <td align="center">
                    ...
                    <div id="MPEBody_Captura" runat="server" class="modalPopup_body" align="left">
                        <table width="100%" class="table table_noborder" border="1" style="border: solid 1px #efefef;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLFaseE" Width="95%" CssClass="form-control">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TBAlimentoE" runat="server" CssClass="form-control text-uppercase" AutoCompleteType="Disabled"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">
                                ...
                                <td>
                                    <asp:TextBox ID="TBCostoE" runat="server" CssClass="form-control text-uppercase" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" TargetControlID="TBCostoE" runat="server" ValidChars="." FilterType="Numbers,Custom"></asp:FilteredTextBoxExtender>
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">

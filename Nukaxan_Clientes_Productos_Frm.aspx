<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_Nukaxan.Master" CodeBehind="Nukaxan_Clientes_Productos_Frm.aspx.vb" Inherits="NukaxanWEB.Nukaxan_Clientes_Productos_Frm" %>
    ...
    <div class="container-fluid w-100 h-100">
        <asp:UpdatePanel runat="server" ID="UPContenido" UpdateMode="Always">
            <ContentTemplate>
                        ...
                        <table width="100%" runat="server" class="table_noborder" border="0" style="border: 0px;" clientidmode="Static">
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    ...
                                    <div align="left" style="display: block; width: 99%; overflow-y: scroll; height: 290px;">
                                            ...
                                            <HeaderTemplate>
                                                <table width='100%' cellpadding='3' border="1" class="datagrid">
                                                    <thead>
                                                        <tr>
                                                            <th width='7%'>
                                                                <asp:Label runat="server" ID="Label6">ID</asp:Label>
                                                            </th>
                                                            <th width='25%'>
                                                            ...
                                                            <th width='13%'>
                                                                <asp:Label runat="server" ID="Label2">CÓDIGO ALLIX</asp:Label>
                                                            </th>
                                                            <th width='18%'>
                                                                <asp:Label runat="server" ID="Label4">CATEGORÍA</asp:Label>
                                                            </th>
                                                            <th width='12%'>
                                                                <asp:Label runat="server" ID="Label5">ESTATUS</asp:Label>
                                                            </th>
                                                            <th width='12%'>
                                                                <asp:Label runat="server" ID="Label7">ACTUALIZACIÓN</asp:Label>
                                                            </th>
                                                        </tr>
                                                    </thead>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <tr>
                                                    <td align="center " class="justify-content-center">
                                                        <asp:Label runat="server" ID="Label8" Text='<%# Eval("CveProducto")%>' CssClass="control-value color-red"></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Label runat="server" ID="NomProducto" Text='<%# Eval("NomProducto")%>' CssClass="control-value bold"></asp:Label>
                                                        <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveProducto") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                        <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveProducto") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                    </td>
                                                    <td align="center " class="justify-content-center">
                                                        ...
                                                        <asp:Label runat="server" ID="DependenciasM" Text='<%# Eval("DependenciasM")%>' Visible="false"></asp:Label>
                                                        <asp:Label runat="server" ID="CveEstatus" Text='<%# Eval("CveEstatus")%>' Visible="false"></asp:Label>
                                                        <asp:Label runat="server" ID="CodProducto" Text='<%# Eval("CodProducto")%>' CssClass="control-value bold"></asp:Label>
                                                    </td>
                                                    <td align="center">
                                                        <asp:Label runat="server" ID="CodALLIX" Text='<%# Eval("CodALLIX")%>' CssClass="control-value "></asp:Label>
                                                    </td>
                                                    <td align="center">
                                                        <asp:Label runat="server" ID="NomCategoriaP" Text='<%# Eval("NomCategoriaP")%>' CssClass="control-value "></asp:Label>
                                                    </td>
                                                    <td align="center">
                ...
                <%--SHOW POPUP--%>
                <asp:Label runat="server" ID="DependenciasM"  Visible="false"></asp:Label>
                    ...
                    <div id="MPEBody_Captura" runat="server" class="modalPopup_body" align="left">
                        <table width="100%" class="table table_noborder" border="1" style="border: solid 1px #efefef;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label runat="server" ID="TBID" CssClass="control-label semibold color-red"></asp:Label>                                    
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TBCodigoE" runat="server" CssClass="form-control text-uppercase" AutoCompleteType="Disabled" Width="150px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLCategoriaE" Width="95%" CssClass="form-control">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TBCodigoALLIXE" runat="server" CssClass="form-control text-uppercase" AutoCompleteType="Disabled" Width="150px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">

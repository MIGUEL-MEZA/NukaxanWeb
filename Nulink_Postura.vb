...
Public Class Nulink_Postura
    ...
    Public Function GetSQL(CodCliente As String, CveParvada As Integer, CveCaseta As Integer, Semana As Integer) As String
        ...
        sb.Append(" EXEC spc_Nulink_PosturaDiaria @CodCliente,@CveParvada,@CveCaseta,@Semana,@Estatus Output,@Mensaje Output")
    ...
    Public Function GetSQLSemana(CodCliente As String, CveParvada As Integer, CveCaseta As Integer) As String
        ...
        sb.Append(" EXEC spc_Nulink_PosturaSemanal @CodCliente,@CveParvada,@CveCaseta,@Estatus Output,@Mensaje Output")

                        ...
                        <div role="tabpanel" class="tab-pane" id="sec2">
                            <div align="left" style="display: block;">
                                <asp:Repeater ID="rptResultado" runat="server">
                                    <HeaderTemplate>
                                        <table width='160%' cellpadding='3' border="1" class="table table-condensed  table-sm table-rep">
                                            <thead>
                                                <tr>
                                                    <th width='20%'>
                                                    ...
                                                    <th width='10%'>
                                                        <asp:Label runat="server" ID="Label15">MASA DE HUEVO (Kg/FASE)</asp:Label>
                                                    </th>
                                                    <th width='10%'>
                                ...
                                <tbody>                                   
                                    <tr>
                                        <td width="60%" style="text-align: left!important;">
                                            <asp:Label runat="server" ID="LBAEPT1" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td width="40%">
                                            <asp:Label runat="server" ID="TBAEPT1"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left!important;">
                                            <asp:Label runat="server" ID="LBAEPT2" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="TBAEPT2"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                       <td style="text-align: left!important;">
                                            <asp:Label runat="server" ID="LBAEPT3" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="TBAEPT3"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                       <td style="text-align: left!important;">
                                            <asp:Label runat="server" ID="LBAEPT4" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="TBAEPT4"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                       <td style="text-align: left!important;">
                                            <asp:Label runat="server" ID="LBAEPT5" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="TBAEPT5"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                       <td style="text-align: left!important;border-bottom:solid 1px gray;">
                                            <asp:Label runat="server" ID="LBAEPT6" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td style="border-bottom:solid 1px gray;">
                                            <asp:Label runat="server" ID="TBAEPT6"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                       <td style="text-align: left!important;">
                                            <asp:Label runat="server" ID="LBAEPT7" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="TBAEPT7"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                       <td style="text-align: left!important;">
                                            <asp:Label runat="server" ID="LBAEPT8" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="TBAEPT8"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                       <td style="text-align: left!important;">
                                            <asp:Label runat="server" ID="LBAEPT9" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="TBAEPT9"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                       <td style="text-align: left!important;">
                                            <asp:Label runat="server" ID="LBAEPT10" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="TBAEPT10"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                       <td style="text-align: left!important;">
                                            <asp:Label runat="server" ID="LBAEPT11" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="TBAEPT11"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                       <td style="text-align: left!important;">
                                            <asp:Label runat="server" ID="LBAEPT12" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="TBAEPT12"></asp:Label>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table id="tbl_resultado3" cellpadding='3' border="0" class="table table-condensed  table-sm table-rep" style="width: 50%!important;">
                                ...
                                <tbody>                                   
                                    ...
                                    <tr>
                                        <td width="60%" style="text-align: left!important;border-bottom:solid 1px gray;">
                                            <asp:Label runat="server" ID="LBAEPP6" CssClass="semibold"></asp:Label>
                                        </td>
                                        <td width="40%" style="border-bottom:solid 1px gray;">

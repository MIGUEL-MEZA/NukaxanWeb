...
Public Class Nulink_Admin_CatLineasGeneticas_View
    Inherits Page
    Private ObjUser As UsuarioModel
    Private Plataforma As String = "5"
    ...
    Protected Sub GVRowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gv1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim IB2 As ImageButton = TryCast(e.Row.FindControl("IB2"), ImageButton)
    ...
    Sub ObtenDatos()
        ...
        Try
            gv1.PageIndex = 0
            dt = New ProdAves_CatLineasGeneticas().FindAll(0)
            Session("DatosGV") = dt
            LlenaGV(dt)
        Catch ex As Exception
    ...
    Sub Exportar()
        ...
        Try
            ...
            dtgv.AsEnumerable.ToList.ForEach(Sub(r)
                                                 ...
                                                 lst.Add(r("CveLineaG"))
                                                 lst.Add(r("NomLineaG"))
                                                 lst.Add(r("CodeLineaG"))
                                                 lst.Add(r("NomEstatus"))
                                                 lst.Add(CDate(r("FecAct")).ToString("dd/MM/yyyy HH:mm"))
                                                 lst.Add(r("NomUsuAct"))
                                                 lstValores.Add(lst)
                                             End Sub)
    ...
    Sub Guardar()
        ...
        Try
            ...
            lstControles.FindAll(Function(p) p.Editable = "S").ForEach(Sub(c)
                                                                       ...
                                                                       End Sub)
            Dim ObjM As New ProdAves_CatLineasGeneticas()
    ...
    Sub mpe_fill()
        Try
            Select Case mpe_op.Text
                Case "action_edit"
                    Dim ObjM As ProdAves_CatLineasGeneticasModel = New ProdAves_CatLineasGeneticas().FindById(CInt(mpe_regId.Text))
                    Dim excepciones As String = ""

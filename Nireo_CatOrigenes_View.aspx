<%@ Page Title="" Language="VB" Async="true" MasterPageFile="~/Master_Nireo.Master" AutoEventWireup="true" CodeBehind="Nireo_CatOrigenes_View.aspx.vb" Inherits="NukaxanWEB.Nireo_CatOrigenes_View" %>
        ...
        <asp:UpdatePanel runat="server" ID="UPContenido" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div style="overflow-y: scroll; height: 59vh; width: 100%; border: solid 0px red;">
                    <%--Grid--%>
                    <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" DataKeyNames="CveOrigen" ShowHeader="true"
                        Width="100%" ShowFooter="false" AllowPaging="True" CellPadding="1"
                        CssClass="datagrid">
                        <HeaderStyle />
                        <Columns>
                            <asp:BoundField DataField="CveOrigen" HeaderText="" HeaderStyle-Width="7%" />
                            <asp:TemplateField HeaderText="" HeaderStyle-Width="33%">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="FolioR" runat="server" Text='<%# Eval("NomOrigen") %>'></asp:Label>
                                    ...
                                    <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                        <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveOrigen") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                            ImageAlign="AbsMiddle" />                                       
                                        <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveOrigen") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                            ImageAlign="AbsMiddle" />
                                    </asp:Panel>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="CodOrigen" HeaderText="" HeaderStyle-Width="10%" />                            
                    ...
                    <div id="MPEBody_Captura" runat="server" class="modalPopup_body" align="left" >
                        <table width="100%" class="table table_noborder" border="1" style="border:solid 1px #efefef;">
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <asp:TextBox ID="TBCodOrigenE" runat="server" CssClass="form-control ucase" Width="170px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="table-td">
                                ...
                                <td valign="top">
                                    <asp:TextBox ID="TBNomOrigenE" runat="server" CssClass="form-control ucase" Width="100%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="table-td">

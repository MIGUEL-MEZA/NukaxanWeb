<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_ProdAves.Master" CodeBehind="ProdAves_PerfilClientes_ClasificacionH_Frm.aspx.vb" Inherits="NukaxanWEB.ProdAves_PerfilClientes_ClasificacionH_Frm" %>
                                    ...
                                    <div align="left" style="display: block; width: 100%; overflow-y: scroll; height: 300px;">
                                        <asp:Repeater ID="rptRegistros" runat="server">
                                                ...
                                                <table width='100%' cellpadding='3' border="1" class="datagrid">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width='9%'>
                                                                <asp:Label runat="server" ID="Label2">PZA X CAJA</asp:Label>
                                                            </th>
                                                            <th width='9%'>
                                                                <asp:Label runat="server" ID="Label8">CONOS X CAJA</asp:Label>
                                                            </th>
                                                             <th width='9%'>
                                                                <asp:Label runat="server" ID="Label7">PZA X CONO</asp:Label>
                                                            </th>                                                             
                                                             <th width='10%'>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td align="center">
                                                        <asp:Label runat="server" ID="CveClasificacionH" Text='<%# Eval("CveClasificacionH")%>' CssClass="control-value bold"></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Label runat="server" ID="FolioR" Text='<%# Eval("NomClasificacionH")%>' CssClass="control-value bold"></asp:Label>                                                        
                                                        ...
                                                        <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                                            <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveClasificacionH") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                        <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveClasificacionH") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                        </asp:Panel>
                                                    </td>
                                                     <td align="center">
                                                        <asp:Label runat="server" ID="PiezasCaja" Text='<%# Eval("PiezasCaja")%>' CssClass="control-value"></asp:Label>
                                                    </td>
                                                    <td align="center">
                                                        <asp:Label runat="server" ID="ConosCaja" Text='<%# Eval("ConosCaja")%>' CssClass="control-value"></asp:Label>
                                                    </td>
                                                     <td align="center">
                                                        <asp:Label runat="server" ID="PiezasCono" Text='<%# Eval("PiezasCono")%>' CssClass="control-value"></asp:Label>
                                                    </td>                                                    
                    ...
                    <div id="MPEBody_Captura" runat="server" class="modalPopup_body" align="left">
                        <table width="100%" class="table table_noborder" border="1" style="border: solid 1px #efefef;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TBPzaCajaE" runat="server" CssClass="form-control " AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FTE1" TargetControlID="TBPzaCajaE" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">
                                ...
                                <td>
                                    <asp:TextBox ID="TBConosCajaE" runat="server" CssClass="form-control " AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FTE2" TargetControlID="TBConosCajaE" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">
                                ...
                                <td>
                                    <asp:TextBox ID="TBPzaConoE" runat="server" CssClass="form-control " AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FTE3" TargetControlID="TBPzaConoE" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                                </td>
                            </tr>                            
                            <tr>
                                <td class="table-td">

...
Public Class ProdAves_PerfilClientes_ClasificacionH_Frm
    Inherits Page
    Private ObjUser As UsuarioModel
    Private Plataforma As String = "54"
    Private menu As String = "43"
    ...
    Sub LlenaRPT()
        Try
            rptRegistros.DataSource = New ProdAves_PerfilCliente_ClasificacionH().FindAll(regPId.Text, 0)
    ...
    Sub Guardar()
        ...
        Try
            ...
            Dim ObjM As New ProdAves_PerfilCliente_ClasificacionH()
    ...
    Sub Eliminar(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            Dim ObjM As New ProdAves_PerfilCliente_ClasificacionH()
            Dim Valores As String = regPId.Text + "|" + key
    ...
    Sub mpe_open()
        ...
        Select Case mpe_op.Text
            Case "action_add"
                ...
                lblMPE_title.Text = "Nueva Clasificación"
                pnlCaptura.Width = 650
                pnlCaptura.Height = 390
                BTNP16.Visible = True
            ...
            Case "action_edit"
                MPEBody_Captura.Visible = True
                lblMPE_title.Text = "Editar Clasificación"
                pnlCaptura.Width = 650
                pnlCaptura.Height = 390
                BTNP16.Visible = True
                BTNP16.Text = lstAcciones.Find(Function(p) p.CveTipo = 1 And p.CveAccion = 6).NomAccion
    ...
    Sub mpe_fill()
        Try
            Select Case mpe_op.Text
                Case "action_edit"
                    Dim ObjM As ProdAves_PerfilCliente_ClasificacionHModel = New ProdAves_PerfilCliente_ClasificacionH().FindById(regPId.Text, CInt(mpe_regId.Text))

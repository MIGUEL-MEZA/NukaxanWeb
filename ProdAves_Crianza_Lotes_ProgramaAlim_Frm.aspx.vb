...
Public Class ProdAves_Crianza_Lotes_ProgramaAlim_Frm
    Inherits Page
    Private ObjUser As UsuarioModel
    Private Plataforma As String = "54"
    Private menu As String = "23"
    Private menuC As String = "233"
    Private CveEtapa As Integer = 1
    'Variables Generales
    ...
    Sub Controles(op As Boolean, Optional controles As String = "")
        Try
            Dim excepciones As String = "54-233-1"
    ...
    Sub Guardar()
        ...
        Try
            ...
            Dim Valores As String = CodCliente.Text + "|" + regPId.Text + "|" + CveEtapa.ToString + "|" + String.Join("|", lst)
    ...
    Sub Eliminar(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            Dim ObjM As New ProdAves_Lotes_ProgramaA()
            Dim Valores As String = CodCliente.Text + "|" + regPId.Text + "|" + CveEtapa.ToString + "|" + key.Split("-")(0) + "|" + key.Split("-")(1)

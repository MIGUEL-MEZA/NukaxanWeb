<%@ Page Title="" Language="VB" Async="true" MasterPageFile="~/Master_ProdAves.Master" AutoEventWireup="true" CodeBehind="ProdAves_CatGuias_View.aspx.vb" Inherits="NukaxanWEB.ProdAves_CatGuias_View" %>
            ...
            <ContentTemplate>
                ...
                <div style="overflow-y: scroll; height: 59vh; width: 100%; border: solid 0px red;">
                    ...
                    <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" DataKeyNames="CveLineaG" ShowHeader="true"
                        ...
                        <HeaderStyle />
                        <Columns>
                            <asp:BoundField DataField="CveGuia" HeaderText="" HeaderStyle-Width="7%" />                            
                            <asp:TemplateField HeaderText="" HeaderStyle-Width="48%">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="Dependencias" Text='<%# Eval("Dependencias") %>' Visible="false"></asp:Label>
                                    <asp:Label runat="server" ID="CveLineaG" Text='<%# Eval("CveLineaG") %>' Visible="false"></asp:Label>
                                    <asp:Label ID="FolioR" runat="server" Text='<%# Eval("NomGuia")%>'></asp:Label>
                                    ...
                                    <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                        <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveGuia") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                            ImageAlign="AbsMiddle" />                                       
                                        <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveGuia") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                            ImageAlign="AbsMiddle" />
                                    </asp:Panel>
                                </ItemTemplate>
                            </asp:TemplateField>                            
                            <asp:BoundField DataField="NomEstatus" HeaderText="" HeaderStyle-Width="15%" />
                            <asp:BoundField DataField="FecAct" HeaderText="" HeaderStyle-Width="10%" DataFormatString="{0:dd/MM/yyyy HH:mm}" />
                            <asp:BoundField DataField="NomUsuAct" HeaderText="" HeaderStyle-Width="20%" />
                        </Columns>
                    ...
                    <div id="MPEBody_Captura" runat="server" class="modalPopup_body" align="left" >
                        <table width="100%" class="table table_noborder" border="1" style="border:solid 1px #efefef;">
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <asp:DropDownList runat="server" ID="DDLineaGE" CssClass="form-control" >
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td valign="top">
                                    <asp:TextBox ID="TBPeriodoE" runat="server" CssClass="form-control " Width="100px" MaxLength="4" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" TargetControlID="TBPeriodoE" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" class="table-td">

...
Public Class Nukaxan_Clientes_Frm
    Inherits Page
    ...
    End Sub
    Sub LlenaDDL()
        Call New Catalogos().LlenaCteOrigen(DDLOrigen)
        Call New Catalogos().LlenaEstatusGeneral(DDLEstatus)
        'Call New Catalogos().LlenaRoles(DDLRolE)
    End Sub
    ...
    Sub LlenaRegistro()
        Try
            If regPId.Text = "0" Then
                Call New Catalogos().LlenaCteOrigen(DDLOrigen, " AND CveOrigen IN(2,3)")
                'DDLOrigen.SelectedValue = 2
    ...
    Function Valida() As Boolean
        ...
        Try
            Dim excepciones As String = ""
            If DDLOrigen.SelectedValue.ToString = "3" Then excepciones = "1-61-3"

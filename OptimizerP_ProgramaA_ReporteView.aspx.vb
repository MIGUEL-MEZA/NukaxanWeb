...
Public Class OptimizerP_ProgramaA_ReporteView
    Inherits Page
    ...
    Sub Etiquetas()
        ...
        PageTitle.Text = "Perfil Nutricional - Reporte" 'lstMenu.NomMenu
    ...
    Sub ObtenDatos()
        ...
        Try
            gv1.PageIndex = 0
            dt = New OptimizerP_ProgramaA().FindAll(0, 0, ObjUser.CodUsuario)
            Session("DatosGV") = dt
            LlenaGV(dt)
        Catch ex As Exception

<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_ProdAves.Master" CodeBehind="ProdAves_PerfilClientes_LineasGeneticas_Frm.aspx.vb" Inherits="NukaxanWEB.ProdAves_PerfilClientes_LineasGeneticas_Frm" %>
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                   <%-- <div style="padding: 5px 0px;">
                                    ...
                                    <br />
                                    <div align="left" style="display: block; width: 900px; overflow-y: scroll; height: 300px;">
                                        <asp:Repeater ID="rptRegistros" runat="server">
                                                ...
                                                <table width='100%' cellpadding='3' border="1" class="datagrid">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width='50%'>
                                                                <asp:Label runat="server" ID="Label1">LÍNEA GENÉTICA</asp:Label>
                                                            </th>
                                                             <th width='20%'>
                                                                <asp:Label runat="server" ID="Label5">ESTATUS</asp:Label>
                                                            </th>
                                                            <th width='20%'>
                                                                <asp:Label runat="server" ID="Label2">FECHA ACTUALIZACIÓN</asp:Label>
                                                            </th>
                                                        </tr>
                                                    </thead>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <asp:Label runat="server" ID="NomLineaG" Text='<%# Eval("NomLineaG")%>' CssClass="control-value bold" ></asp:Label>
                                                    </td>
                                                     <td align="center">
                                                        <asp:DropDownList runat="server" ID="DDLEstatus" Width="130px" CssClass="form-control">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td align="center">
                                                        <asp:Label runat="server" ID="FecAct" Text='<%# If(IsDBNull(Eval("FecAct")), "", CDate(Eval("FecAct")).ToString("dd/MM/yyyy"))%>' CssClass="control-value "></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>

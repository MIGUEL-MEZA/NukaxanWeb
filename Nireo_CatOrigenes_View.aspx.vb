...
Public Class Nireo_CatOrigenes_View
    Inherits Page
    ...
    Sub ObtenDatos()
        ...
        Try
            gv1.PageIndex = 0
            dt = New Nireo_CatOrigenes().FindAll(0)
            Session("DatosGV") = dt
            LlenaGV(dt)
        Catch ex As Exception
    ...
    Sub Guardar()
        ...
        Try
            ...
            lstControles.FindAll(Function(p) p.Editable = "S").ForEach(Sub(c)
                                                                       ...
                                                                       End Sub)
            Dim ObjM As New Nireo_CatOrigenes()
    ...
    Sub mpe_fill()
        Try
            Select Case mpe_op.Text
                Case "action_edit"
                    Dim ObjM As Nireo_CatOrigenesModel = New Nireo_CatOrigenes().FindById(CInt(mpe_regId.Text))
                    Dim excepciones As String = ""

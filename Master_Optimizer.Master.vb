...
Public Class Master_Optimizer
    ...
    Sub Etiquetas()
        'Titulo
        'LBLEslogan.Text = New Plataforma().FindById(ObjUser.CveRol, Plataforma, 0).Descripcion
        ' LBLTitulo.Text = "PLATAFORMAS DE SERVICIO" 'New Plataforma().FindById(ObjUser.CveRol, Plataforma, 0).NomPlataforma

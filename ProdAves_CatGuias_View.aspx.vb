...
Public Class ProdAves_CatGuias_View
    Inherits Page
    ...
    Sub LlenaDDL()
        ...
        Call New Catalogos().Llena_ProdAvesLineaG(DDLineaGE)
    End Sub
    Sub SeguridadLoad()
    ...
    Sub ObtenDatos()
        ...
        Try
            gv1.PageIndex = 0
            dt = New ProdAves_CatGuias().FindAll(0)
            Session("DatosGV") = dt
            LlenaGV(dt)
        Catch ex As Exception
    ...
    Sub Guardar()
        ...
        Try
            ...
            lstControles.FindAll(Function(p) p.Editable = "S").ForEach(Sub(c)
                                                                       ...
                                                                       End Sub)
            Dim ObjM As New ProdAves_CatGuias()
    ...
    Sub mpe_fill()
        Try
            Select Case mpe_op.Text
                Case "action_edit"
                    Dim ObjM As ProdAves_CatGuiasModel = New ProdAves_CatGuias().FindById(CInt(mpe_regId.Text))
                    Dim excepciones As String = ""

...
Public Class Nireo_Resultados2_View
    Inherits Page
    ...
    End Sub
    Protected Sub DDLFiltroProducto_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DDLFiltroProducto.SelectedIndexChanged
        'DefineGV()
    End Sub
    ...
    Sub DefineGV(filtros As String)
        ...
        Try
            ...
            dtCol = New Consultas().Columnas(CInt(Plataforma), CInt(menu), filtros)
    ...
    Sub Buscar()
        ...
        Try
            ...
            Dim tmp() As String = filtros.Split("|")
            tmp(1) = ""
            filtros = String.Join("|", tmp)
            DefineGV(filtros)
            dt = New Consultas().Datos(CInt(Plataforma), CInt(menu), filtros)
            gv1.PageIndex = 0
            Session("DatosGV") = dt
            LlenaGV(dt)
            'initDropDowns()

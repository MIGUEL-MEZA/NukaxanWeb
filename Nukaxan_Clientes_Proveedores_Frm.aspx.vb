...
Public Class Nukaxan_Clientes_Proveedores_Frm
    Inherits Page
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        lstControles = New Controles_Captura().FindlstAll(CInt(Plataforma), CInt(menu + "8"), 0)
    ...
    Sub Etiquetas()
        ...
        Menu_Titulo.Text = New Menu_Formulario().FindById(Plataforma, menu, 8).NomMenu
    ...
    Sub LlenaRPT()
        Try
            rptProductos.DataSource = New Clientes_Proveedores().FindAll(regPId.Text, 0)
    ...
    Sub Agregar()
        ...
        Try
            ...
            Dim ObjM As New Clientes_Proveedores()
            IsResult = ObjM.SaveModel(regPId.Text, CInt(mpe_regId.Text), Valores, ObjUser.CodUsuario)
            If IsResult Then
                LlenaRPT()
    ...
    Sub mpe_fill()
        Try
            Select Case mpe_op.Text
                Case "action_edit"
                    Dim ObjM As Clientes_ProveedoresModel = New Clientes_Proveedores().FindById(regPId.Text, CInt(mpe_regId.Text))

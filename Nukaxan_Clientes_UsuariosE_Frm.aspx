<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_Nukaxan.Master" CodeBehind="Nukaxan_Clientes_UsuariosE_Frm.aspx.vb" Inherits="NukaxanWEB.Nukaxan_Clientes_UsuariosE_Frm" %>
                        ...
                        <table width="100%" runat="server" class="table_noborder" border="0" style="border: 0px;" clientidmode="Static">
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    ...
                                    <div runat="server" class="bar-actions" style="display: inline-block;" visible="false">

...
Public Class Interfaz_OptimizerP
    ...
    Public Sub New()
        path = ConfigurationManager.AppSettings("WSOptimizerPollos")
        'WsUsuario.email = "mbravo@gponutec.com"
        'WsUsuario.password = "Nukaxan#23"
    End Sub

    Public Async Function GeneraPerfil(ReqBody As WSOptimizerP_PerfilN_RequestModel) As Task(Of ResponseModel)
        ...
        Return lst
    End Function
    Public Async Function GeneraPlan(ReqBody As WSOptimizerP_PlanA_RequestModel) As Task(Of WSOptimizerP_PlanA_ResponseModel)
        Dim lst As WSOptimizerP_PlanA_ResponseModel
        ...
        Try
            ...
            If (response.StatusCode = System.Net.HttpStatusCode.OK) Then
                WSEstatus = True
                lst = Await response.Content.ReadAsAsync(Of WSOptimizerP_PlanA_ResponseModel)
            Else
                'Dim errorWS As WSErrorModel = Await response.Content.ReadAsAsync(Of WSErrorModel)

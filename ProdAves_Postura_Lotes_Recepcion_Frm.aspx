<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_ProdAves.Master" CodeBehind="ProdAves_Postura_Lotes_Recepcion_Frm.aspx.vb" Inherits="NukaxanWEB.ProdAves_Postura_Lotes_Recepcion_Frm" %>
                                ...
                                <div align="left" style="display: block; width: 100%; overflow-y: scroll; height: 300px;">
                                    <asp:Repeater ID="rptRegistros" runat="server">
                                            ...
                                            <table width='100%' cellpadding='3' border="1" class="datagrid">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width='12%'>
                                                            <asp:Label runat="server" ID="Label1">FECHA RECEPCIÓN</asp:Label>
                                                        </th>                                                       
                                                        <th width='11%'>
                                                            <asp:Label runat="server" ID="Label4">AVES ALOJADAS</asp:Label>
                                                        </th>
                                                        <th width='9'>
                                                            <asp:Label runat="server" ID="Label6">PESO INICIAL</asp:Label>
                                                        </th>
                                                         <th width='9%'>
                                                            <asp:Label runat="server" ID="Label2">EDAD INICIAL</asp:Label>
                                                        </th>
                                                         <th width='9%'>
                                                            <asp:Label runat="server" ID="Label7">DÍA INICIAL</asp:Label>
                                                        </th>
                                                        <th width='12%'>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td align="left">
                                                    <asp:Label runat="server" ID="CveGranja" Text='<%# Eval("CveGranja")%>' Visible="false"></asp:Label>
                                                    <asp:Label runat="server" ID="FolioR" Text='<%# Eval("NomCaseta")%>' CssClass="control-value bold"></asp:Label>
                                                    ...
                                                    <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                                        <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveLoteR") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                        <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveLoteR") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                    </asp:Panel>
                                                </td>
                                                <td align="center " class="justify-content-center">
                                                    <asp:Label runat="server" ID="FecRecepcion" Text='<%# Convert.ToDateTime(Eval("FecRecepcion")).ToString("dd/MM/yyyy")%>' CssClass="control-value "></asp:Label>

                                                </td>                                               
                                                <td align="center">
                                                    <asp:Label runat="server" ID="AvesAlojadas" Text='<%# CDbl(Eval("AvesAlojadas")).ToString("N0")%>'  CssClass="control-value "></asp:Label>
                                                </td>
                                                <td align="center">
                                                    <asp:Label runat="server" ID="PesoInicial" Text='<%# Eval("PesoInicial")%>' CssClass="control-value "></asp:Label>
                                                </td>
                                                 <td align="center">
                    ...
                    <div id="MPEBody_Captura" runat="server" class="modalPopup_body" align="left">
                        <table width="100%" class="table table_noborder" border="1" style="border: solid 1px #efefef;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLCasetaE" CssClass="form-control">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TBFecRecepcionE" runat="server" CssClass="form-control text-uppercase" Width="150px" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:CalendarExtender runat="server" ID="CalendarExtender9" Animated="true" Format="dd/MM/yyyy" TargetControlID="TBFecRecepcionE"></asp:CalendarExtender>
                                </td>
                            </tr>                            
                            <tr>
                                <td class="table-td">
                                ...
                                <td>
                                    <asp:TextBox ID="TBAvesAlojadasE" runat="server" CssClass="form-control " Width="150px" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" TargetControlID="TBAvesAlojadasE" runat="server" FilterType="Numbers"></asp:FilteredTextBoxExtender>
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">
                                ...
                                <td>
                                    <asp:TextBox ID="TBPesoInicialE" runat="server" CssClass="form-control " Width="150px" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" TargetControlID="TBPesoInicialE" runat="server" FilterType="Custom,Numbers" ValidChars="."></asp:FilteredTextBoxExtender>
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">
                                ...
                                <td>
                                    <asp:TextBox ID="TBEdadE" runat="server" CssClass="form-control text-uppercase" Width="150px" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FTE1" runat="server" FilterType="Numbers" TargetControlID="TBEdadE"  />
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">
                                ...
                                <td>
                                    <asp:TextBox ID="TBDiaE" runat="server" CssClass="form-control text-uppercase" Width="150px" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FTE2" runat="server" FilterType="Numbers" TargetControlID="TBDiaE"  />
                                </td>
                            </tr>
                            <tr>
                                <td class="table-td">
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DDLEstatusE" Width="200px" CssClass="form-control semibold">
                                    </asp:DropDownList>

<%@ Page Title="" Language="VB" Async="true" AutoEventWireup="true" MasterPageFile="~/Master_ProdAves.Master" CodeBehind="ProdAves_PerfilClientes_Granjas_Frm.aspx.vb" Inherits="NukaxanWEB.ProdAves_PerfilClientes_Granjas_Frm" %>
                                    ...
                                    <div align="left" style="display: block; width: 100%; overflow-y: scroll; height: 300px;">
                                        <asp:Repeater ID="rptRegistros" runat="server">
                                                ...
                                                <table width='100%' cellpadding='3' border="1" class="datagrid">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width='10%'>
                                                                <asp:Label runat="server" ID="Label2">CASETAS</asp:Label>
                                                            </th>
                                                             <th width='13%'>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td align="center">
                                                        <asp:Label runat="server" ID="CveGranja" Text='<%# Eval("CveGranja")%>' CssClass="control-value bold"></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Label runat="server" ID="FolioR" Text='<%# Eval("NomGranja")%>' CssClass="control-value bold"></asp:Label>                                                        
                                                        ...
                                                        <asp:Panel ID="pnl_action" runat="server" CssClass="panel-action">
                                                            <asp:ImageButton runat="server" ID="IB1" OnClick="Editar" CommandArgument='<%# Eval("CveGranja") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                        <asp:ImageButton runat="server" ID="IB2" OnClick="Eliminar" CommandArgument='<%# Eval("CveGranja") %>' ImageUrl="Content/Image/icon_file_jpg.png"
                                                            ImageAlign="AbsMiddle" />
                                                        </asp:Panel>
                                                    </td>
                                                    <td align="center " class="justify-content-center">                                                        
                                                        ...
                                                        <asp:Label runat="server" ID="TotalCasetas" Text='<%# Eval("TotalCasetas")%>' CssClass="control-value"></asp:Label>
                                                    </td>
                                                     <td align="center">
